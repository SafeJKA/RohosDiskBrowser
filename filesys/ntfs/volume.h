...
extern int ntfs_umount(ntfs_volume *vol, const BOOL1 force);
...
extern s64 ntfs_volume_get_free_space2(ntfs_volume *vol);
extern s64 ntfs_volume_space(ntfs_volume *vol);
