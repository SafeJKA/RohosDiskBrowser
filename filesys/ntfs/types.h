...
typedef unsigned __int8  u8;			/* Unsigned types of an exact size */
typedef unsigned __int16 u16;
typedef unsigned __int32 u32;
typedef unsigned __int64 u64;

typedef __int8  s8;			/* Signed types of an exact size */
typedef __int16 s16;
typedef __int32 s32;
typedef __int64 s64;
...
/*
 * Cygwin has a collision between our BOOL1 and <windef.h>'s
 * As long as this file will be included after <windows.h> were fine.
 */
#ifndef _WINDEF_H
/**
 * enum BOOL1 - These are just to make the code more readable...
 */
typedef enum {
#ifndef FALSE
	FALSE = 0,
