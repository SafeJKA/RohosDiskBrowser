 ...
 */
void ntfs_attr_init(ntfs_attr *na, const BOOL1 non_resident,
		const BOOL1 compressed, const BOOL1 encrypted, const BOOL1 sparse,
		...
		ntfschar *name, u8 name_len, u8 *val, s64 size)
{
	...
	int err, i, offset;
	BOOL1 is_resident;
	BOOL1 can_be_non_resident = FALSE;
	ntfs_inode *attr_ni;
	ntfs_attr *na;
	...
	if (is_resident)
		...
		attr_rec_size = /*offsetof(ATTR_RECORD, non_resident_end)*/64 +
