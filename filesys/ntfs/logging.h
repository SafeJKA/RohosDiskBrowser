...
#define ntfs_log_critical(FORMAT, ARGS) WriteLog2(FORMAT)
#define ntfs_log_error(FORMAT, ARGS) WriteLog2(FORMAT)
#define ntfs_log_info(FORMAT, ARGS) //ntfs_log_redirect(__FUNCTION__,__FILE__,__LINE__,NTFS_LOG_LEVEL_INFO,NULL,FORMAT,##ARGS)
#define ntfs_log_perror(FORMAT, ARGS) WriteLog2(FORMAT)
