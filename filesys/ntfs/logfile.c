 ...
 */
static BOOL1 ntfs_check_restart_page_header(RESTART_PAGE_HEADER *rp, s64 pos)
{
 ...
 * require the full restart page.
 */
static BOOL1 ntfs_check_restart_area(RESTART_PAGE_HEADER *rp)
{
	u64 file_size;
	RESTART_AREA *ra;
 ...
 */
static BOOL1 ntfs_check_log_client_array(RESTART_PAGE_HEADER *rp)
{
	RESTART_AREA *ra;
	LOG_CLIENT_RECORD *ca, *cr;
	u16 nr_clients, idx;
	BOOL1 in_free_list, idx_is_first;
 ...
 */
BOOL1 ntfs_check_logfile(ntfs_attr *log_na, RESTART_PAGE_HEADER **rp)
{
	s64 size, pos;
 ...
 */
BOOL1 ntfs_is_logfile_clean(ntfs_attr *log_na, RESTART_PAGE_HEADER *rp)
{
	RESTART_AREA *ra;

	le16 i1 = sizeof(RESTART_AREA);
	le16 i2 = sizeof(RESTART_PAGE_HEADER);
	...
	if (ra->client_in_use_list != /*LOGFILE_NO_CLIENT*/0 &&
