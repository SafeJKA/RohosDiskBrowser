 ...
 */
static BOOL1 ntfs_rl_are_mergeable(runlist_element *dst, runlist_element *src)
{
	if (!dst || !src) {
...
{
	BOOL1 right = FALSE;	/* Right end of @src needs merging */
...
static runlist_element *ntfs_rl_insert(runlist_element *dst, int dsize,
				       runlist_element *src, int ssize, int loc)
{
	BOOL1 left = FALSE;	/* Left end of @src needs merging */
	BOOL1 disc = FALSE;	/* Discontinuity between @dst and @src */
	int marker;		/* End of the inserted runs */
 ...
 * Returns:
 */
static runlist_element * test_rl_pure_src(BOOL1 contig, BOOL1 multi, int vcn, int len)
{
 ...
 * Returns:
 */
static void test_rl_pure_test(int test, BOOL1 contig, BOOL1 multi, int vcn, int len, runlist_element *file, int size)
{
	runlist_element *src;
	runlist_element *dst;
	runlist_element *res;
